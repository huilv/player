...
public class FordAdapter extends RecyclerView.Adapter<FordAdapter.CommonViewHolder> {
    ...
    public FordAdapter(Context mContext) {
    ...
    public CommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new CommonViewHolder(mLayoutInflater.inflate(R.layout.layout_ford_item, parent, false));
    }

    @Override
    public void onBindViewHolder(CommonViewHolder holder, int position) {
        final CommonBean commonBean = singerList.get(position);
        holder.singer_textView.setText(commonBean.folder);
